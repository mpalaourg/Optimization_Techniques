function [value,k,min_x,min_y,point_x,point_y] = conjugate_mutable_g(epsilon,x,y)
%conjugate_mutable_g
...
%n steps.The value of g, is according to a heuristic rule.
%I initialize g=0.9293, in order that at the beginning, i shall make 
